...
$dllSources = @(& (Join-Path $projectRoot 'tools/m98wrap-sources.ps1') -ProjectRoot $projectRoot)
& $compiler @flags '-o' (Join-Path $buildDir 'm98wrap.dll') @dllSources '-lkernel32'
