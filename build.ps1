...
& $compiler @flags '-o' (Join-Path $buildDir 'm98wrap.dll') (Join-Path $projectRoot 'src/m98wrap.c') (Join-Path $projectRoot 'src/m98nls_ex.c') (Join-Path $projectRoot 'src/m98_threadpool.c') (Join-Path $projectRoot 'src/m98_initonce.c') (Join-Path $projectRoot 'src/m98_slist.c') (Join-Path $projectRoot 'src/wine_uppercase.c') '-lkernel32'
